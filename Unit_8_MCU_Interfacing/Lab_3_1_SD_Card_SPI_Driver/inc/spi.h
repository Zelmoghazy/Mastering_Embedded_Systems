...
#define SPI_DIR_2_LINES                     0U                      // 2-line unidirectional data mode selected 
#define SPI_DIR_2_LINES_RX_ONLY             (1U<<10U)               // output disabled  
...
#define SPI_DEFAULT_CONFIG() \
    {\
        ...
        .NSS                    = SPI_NSS_HW_MASTER_SSOE,   \
        .baud_presc             = SPI_BAUD_PRESC_16,        \
        .irq_en                 = SPI_IRQ_NONE,             \
        .irq_cb                 = NULL,                     \
    }
