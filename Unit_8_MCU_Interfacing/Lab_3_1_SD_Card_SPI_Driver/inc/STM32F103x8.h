...
#define SPI1_BASE                   (PERIPHERALS_BASE + 0x13000UL)
#define SPI2_BASE                   (PERIPHERALS_BASE + 0x3800UL)

#define I2C1_BASE					(PERIPHERALS_BASE + 0x5400UL)
#define I2C2_BASE					(PERIPHERALS_BASE + 0x5800UL)
