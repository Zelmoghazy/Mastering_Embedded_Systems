...
/* USART STATUS */
#define USART_SR_PE                 (1U<<0U)        // parity error
#define USART_SR_FE                 (1U<<1U)        // framing error
#define USART_SR_NE                 (1U<<2U)        // noise error
#define USART_SR_ORE                (1U<<3U)        // Overrun error
#define USART_SR_IDLE               (1U<<4U)        // IDLE line detected
...
// Convenient macro to quickly setup uart config with default settings
...
#define USART_OVERRUN(usart)    (usart->SR & USART_SR_ORE)
#define USART_REC_DATA(usart)   (usart->SR & USART_SR_RXNE)
