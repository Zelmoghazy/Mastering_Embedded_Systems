...
void setup_gpio(void)
{
    ...
    gpio_config_t a1_cfg = {
        .pin  = GPIO_PIN_1,
        .mode = GPIO_MODE_IN_F,
        .pull = GPIO_PULL_NONE,
    };
    gpio_init(GPIO_A, &a1_cfg);


    gpio_config_t a13_cfg = {
        .pin  = GPIO_PIN_13,
        .mode = GPIO_MODE_IN_F,
        .pull = GPIO_PULL_NONE,
    };
    gpio_init(GPIO_A, &a13_cfg);


    gpio_config_t b1_cfg = {
        .pin  = GPIO_PIN_1,
        .mode = GPIO_MODE_OUT_PP(GPIO_SPEED_10M),
        .pull = GPIO_PULL_NONE,
    };
    gpio_init(GPIO_B, &b1_cfg);


    gpio_config_t b13_cfg = {
        .pin  = GPIO_PIN_13,
        .mode = GPIO_MODE_OUT_PP(GPIO_SPEED_10M),
        .pull = GPIO_PULL_NONE,
    };
    gpio_init(GPIO_B, &b13_cfg);
}
