...
#define GPIO_PIN_3                  ((uint16_t)(1<<( 3U))) 
#define GPIO_PIN_4                  ((uint16_t)(1<<( 4U))) 
#define GPIO_PIN_5                  ((uint16_t)(1<<( 5U))) 
#define GPIO_PIN_6                  ((uint16_t)(1<<( 6U))) 
#define GPIO_PIN_7                  ((uint16_t)(1<<( 7U))) 
#define GPIO_PIN_8                  ((uint16_t)(1<<( 8U))) 
#define GPIO_PIN_9                  ((uint16_t)(1<<( 9U))) 
#define GPIO_PIN_10                 ((uint16_t)(1<<(10U))) 
#define GPIO_PIN_11                 ((uint16_t)(1<<(11U))) 
#define GPIO_PIN_12                 ((uint16_t)(1<<(12U))) 
#define GPIO_PIN_13                 ((uint16_t)(1<<(13U))) 
